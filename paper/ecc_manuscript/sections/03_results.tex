...
\begin{figure}[!htbp]
    \centering
    \includesvg[inkscapelatex=false, width=0.45\textwidth, keepaspectratio]{Figures/observation_error.svg}
...
\begin{figure}[!htbp]
    \centering
    \includesvg[inkscapelatex=false, width=0.45\textwidth, keepaspectratio]{Figures/input.svg}
